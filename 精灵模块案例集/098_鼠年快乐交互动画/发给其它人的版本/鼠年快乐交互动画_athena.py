...
def runcode():
    ...
    mouse.write('本程序用Python精灵模块开发。',align='center',font=('微软雅黑',12,'normal'))
    mouse.setheading(90)
...
b1 = TK.Button(root.frame_right,text='祝你身体健康',command=lambda:mouse.say('祝你身体健康'))
...
popup.add_command(label="你好",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="认识",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="你是",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="我一",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="生中",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="最快",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="乐的",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="事情。",command=lambda:screen.bye())
