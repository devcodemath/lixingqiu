...
popup.add_command(label="各位同事",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="老板,老板娘",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="外地的,本地的",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="鼠年快乐",command=lambda:showinfo('hi','这是真的'))
popup.add_separator()
popup.add_command(label="关闭窗口",command=lambda:screen.bye())
