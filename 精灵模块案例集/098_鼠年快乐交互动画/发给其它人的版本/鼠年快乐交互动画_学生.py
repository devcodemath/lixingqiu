...
b3 = TK.Button(root.frame_right,text='冬练三九',command=lambda:mouse.left(30))
b3.grid(row=2,column=0)

b4 = TK.Button(root.frame_right,text='夏练三伏',command=lambda:mouse.right(30))
...
popup.add_command(label="各位家长与同学们",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="本人在此祝贺大家",command=lambda:showinfo('hi','这是真的'))
popup.add_command(label="鼠年快乐,学有所成",command=lambda:showinfo('hi','这是真的'))
